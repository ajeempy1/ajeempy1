...
import '../static/css/createproject.css';
...
const CreateProject = () => {
    ...
    const handleSubmit = (event) => {
        ...
        // Handle form submission here, such as sending data to your backend
                ...
                <div className="right">
                  <div className="form-container">
                    <div className="form-div">
                      <form onSubmit={handleSubmit} encType="multipart/form-data" className="custom-form">
