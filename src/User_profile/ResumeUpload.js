...
import '../static/css/resumeupload.css';
...
const ResumeUpload = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (!name) {
            setUploadStatus('Please enter your name.');
            event.preventDefault(); // Prevent form submission if name is not provided
            return;
        }
      ...
      <div className="container-fluid">
        ...
        <div className="wrapping">
          <div className="container-fluid">
            ...
            <form
                action="/upload-resume/" // The URL where the form data will be submitted
                method="post"
