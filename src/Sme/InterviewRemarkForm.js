...
const InterviewRemarkForm = () => {
    const [formData, setFormData] = useState({
        sme_name: '',
        course: '',
        interview_round_remark: '',
        remark: ''
    });
      ...
      <div className="container-fluid">
        ...
        <div className="wrapping">
          <div className="container-fluid">
            ...
            <h2>Interview Remark Form</h2>
            <div>
                <label>SME Name:</label>
                <input type="text" name="sme_name" value={formData.sme_name} onChange={handleChange} required />
            </div>
            <div>
                <label>Course:</label>
            ...
            <div>
                ...
                <input type="number" name="interview_round_remark" value={formData.interview_round_remark} onChange={handleChange} required />
            </div>
            <br />
            <div>
                <label>Remark:</label>
                <textarea name="remark" value={formData.remark} onChange={handleChange} required maxLength="500"></textarea>
            </div>
            <div>
...
export default InterviewRemarkForm;
