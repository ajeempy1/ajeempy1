            ...
            <table border="1">
                <thead>
                    <tr>
                        ...
                        <th className="course-duration">Course Duration</th>
                        <th className="course-fee">Course Fee</th>
                    ...
                    {courses && courses.length > 0 ? (
                        courses.map((course, index) => (
                            <tr key={index}>
                                ...
                                <td>{course.course_curriculum}</td>
                            </tr>
                        ))
                    ) : (
                        <tr>
